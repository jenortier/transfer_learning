...
Même chaîne et mêmes options que transfer_pushball_2to3dof.py.

Usage :
    # fenêtre interactive
    cd robot-robot && python3 -m direct_method.visualize_transfer_2to3dof --episodes 3

    # GIF par épisode (sans écran) -> direct_method/runs/eval/transfer_gifs/
    MPLBACKEND=Agg python3 -m direct_method.visualize_transfer_2to3dof --episodes 3 --save
"""
...
def main():
    ...
    p.add_argument("--model-path", default="data/models/ppo_pushball_2dof_rec_1/ppo_pushball_final.zip")
    p.add_argument("--vecnorm-path", default="data/models/ppo_pushball_2dof_rec_1/vec_normalize.pkl")
