"""
runs_transfer_reach_3to2dof.py
Collecte 20 épisodes réussis et 20 échoués — politique 3-DOF transférée → env 2-DOF.
Sauvegarde dans :
  runs/transfer_reach_3to2dof/success/ep_XXX.npz
  runs/transfer_reach_3to2dof/fail/ep_XXX.npz
"""
...
from agents.test.gen_algo.transfer_reaching_3to2dof import ReachingTransfer3to2
...
POLICY_3DOF_PATH  = MODEL_ROOT / f"ppo_reach_3dof_{RUN_ID_3DOF}" / "best_model.zip"
VECNORM_3DOF_PATH = MODEL_ROOT / f"ppo_reach_3dof_{RUN_ID_3DOF}" / "vec_normalize.pkl"
MAPPER_PATH       = DATA_ROOT / "DIRECT_GEN_ALGO" / "transfer_3to2_seq.pt"

N_TARGET  = 20
MAX_STEPS = 100

SAVE_SUCCESS = "runs/transfer_reach_3to2dof/success"
SAVE_FAIL    = "runs/transfer_reach_3to2dof/fail"
os.makedirs(SAVE_SUCCESS, exist_ok=True)
os.makedirs(SAVE_FAIL,    exist_ok=True)

# ── Chargement politique de transfert ─────────────────────────────────────────
policy = ReachingTransfer3to2(
...
print(f"Collecte de {N_TARGET} succès et {N_TARGET} échecs — transfer reaching 3→2 DOF\n")
